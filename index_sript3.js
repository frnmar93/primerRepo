...
$('#Principal').empty();
  ...
  <div id="estadoSidebarContainer" class="cartaSidebar">
    <div>Estado</div>
    <select name="estadoSidebar" id="estadoSidebar">
      <option value="${obj[26]}" selected disabled hidden>${obj[26]}</option>
      <option value="En curso">En curso</option>
      <option value="A ordenar">A ordenar</option>
      <option value="Desestimado">Desestimado</option>
      <option value="Sin cobertura">Sin cobertura</option>
      <option value="Instalado">Instalado</option>
    </select>
  </div>
  <div class="cartaSidebar guestSidebar">
    <div class="checkboxSidebarContainer">
      <label class="checkboxSidebar">Apto contratistas</label>
      <input id="chkboxSidebar" name="checkboxSidebar" type="checkbox" ${conformeContratista}>
    </div>
  </div>
